"""╔═══════════════════ ════════════════════ ════════════════════ ═══════════════════╗
║ PyAuditor — One-Click Update Tool ║
║ (No Git Required) ║
╠═══════════════════ ════════════════════ ════════════════════ ═══════════════════╣
║ This script contains the latest PyAuditor on GitHub. downloads the codes and ║
...
# Backup folder
BACKUP_DIR_NAME = "_pyauditor_backup"
...
def print_banner():
    ...
    print()
    print("╔══════════════════════════════════════════════════════════════╗")
    print("║ 🔄 PyAuditor Update Tool v1.0 ║")
...
def download_with_progress(url: str, dest_path: str) -> bool:
    ...
    try:
        ...
        req = urllib.request.Request(url, headers={"User-Agent": "PyAuditor-Updater/1.0"})
...
def run_update():
    ...
    print("• settings.json (Uygulama ayarları)")
    print("• history/ (Eski tarama raporları)")
    print()
...
if __name__ == "__main__":
    try:
        ...
        if success:
            print("🚀 You can use the current version by restarting PyAuditor")
        else:
